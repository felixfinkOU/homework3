...
<?php
    $var = $row['Club'];
    $section_sql = "SELECT t.Standings, p.LastName as Player, m.LastName as Manager FROM SoccerPlayer as p JOIN Teams as t ON p.Club = t.Club JOIN SoccerManagers as m ON t.Club = m.Club WHERE t.Club='$var'";
